...
const bagsCurveABIJSON = `[{"type":"function","name":"buy","stateMutability":"payable","inputs":[{"name":"minAmountOut","type":"uint256"}],"outputs":[]},{"type":"function","name":"buyFor","stateMutability":"payable","inputs":[{"name":"recipient","type":"address"},{"name":"minAmountOut","type":"uint256"}],"outputs":[]},{"type":"function","name":"sell","stateMutability":"nonpayable","inputs":[{"name":"amountIn","type":"uint256"},{"name":"minAmountOut","type":"uint256"}],"outputs":[]},{"type":"function","name":"sellFor","stateMutability":"nonpayable","inputs":[{"name":"recipient","type":"address"},{"name":"amountIn","type":"uint256"},{"name":"minAmountOut","type":"uint256"}],"outputs":[]},{"type":"function","name":"quoteBuy","stateMutability":"view","inputs":[{"name":"quoteIn","type":"uint256"}],"outputs":[{"name":"tokensOut","type":"uint256"},{"name":"feeQuote","type":"uint256"},{"name":"netQuoteIn","type":"uint256"},{"name":"grossUsed","type":"uint256"},{"name":"refundQuote","type":"uint256"}]},{"type":"function","name":"quoteSell","stateMutability":"view","inputs":[{"name":"tokensIn","type":"uint256"}],"outputs":[{"name":"quoteToSeller","type":"uint256"},{"name":"feeQuote","type":"uint256"},{"name":"grossQuoteOut","type":"uint256"}]}]`
...
const bagsLensABIJSON = `[{"type":"function","name":"getTokenState","stateMutability":"view","inputs":[{"name":"token","type":"address"}],"outputs":[{"name":"state","type":"tuple","components":[{"name":"exists","type":"bool"},{"name":"migrated","type":"bool"},{"name":"curve","type":"address"},{"name":"feeShare","type":"address"},{"name":"poolId","type":"bytes32"},{"name":"thresholdQuote","type":"uint256"},{"name":"realQuoteReserves","type":"uint256"},{"name":"realTokenReserves","type":"uint256"},{"name":"virtualTokenReserves","type":"uint256"},{"name":"virtualQuoteReserves","type":"uint256"},{"name":"priceQuotePerToken","type":"uint256"},{"name":"bondingProgressPct","type":"uint256"},{"name":"totalRaised","type":"uint256"}]}]},{"type":"function","name":"claimableOf","stateMutability":"view","inputs":[{"name":"token","type":"address"},{"name":"user","type":"address"}],"outputs":[{"name":"amount","type":"uint256"}]}]`
...
var (
	...
	bagsLensABI        = mustParseABI(bagsLensABIJSON)
